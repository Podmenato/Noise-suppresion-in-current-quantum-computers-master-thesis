...
if __name__ == '__main__':
    ...
    jobs = prob.measure(state, shots=10000, memory=True)
    results = prob.parse_sequences(jobs, 10000, 5000, 1)
    print(results)

    results = prob.measure(state, shots=5000)
    print(results)
    ...
    # results = seq.parse_sequence_results_single_circuit(sequence, dictionary)
    # print(results)
